...
const ACTIVITY_SYNONYMS: Record<string, string> = {
  ...
  "onecide": "onecide",
  "diuron": "diuron",
  // Spellings and terms found in the real Farm Cost Report.
  "duiron": "diuron",
  "hackot": "hakot_material",
  "planting hackot": "hakot_material",
  "hackot tanim": "hakot_material",
  "deweeder": "deweed",
  "land clearing": "plot_clearing",
  "edge cleaning": "plot_edging",
  "linis plot": "plot_clearing",
  "re araro lines for planting": "araro",
  "planting material collection": "material_collection",
  "planting material gathering material arrangement": "suwe_gathering",
  "agroxone": "agroxone",
